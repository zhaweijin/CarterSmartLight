...
public class ControllerMode3Activity extends BaseActivity {
	...
	class ButtonOnClickListener implements OnClickListener{
		...
		public void onClick(View v) {
			...
			else if(v.getId() == R.id.btn_brightness_plus){
				cmdBytes[0] = 0x33;
			}
	...
	class ButtonOnLongClickListener implements OnLongClickListener{
		...
		public boolean onLongClick(View v) {
			...
			//long command then
			if(v.getId() == R.id.btn_on){
				cmdBytes[0] = (byte) 0xb2;
			}
			else if(v.getId() == R.id.btn_off){
				cmdBytes[0] = (byte) 0xb1;
			}
			else if(v.getId() == R.id.btn_brightness_plus){
				cmdBytes[0] = (byte) 0xb3;
			}
			else if(v.getId() == R.id.btn_brightness_minus){
				cmdBytes[0] = (byte) 0xb4;
			}
			else if(v.getId() == R.id.btn_speed_plus){
				cmdBytes[0] = (byte) 0xb5;
			}	
			else if(v.getId() == R.id.btn_speed_minus){
				cmdBytes[0] = (byte) 0xb6;
			}
			else if(v.getId() == R.id.btn_program_plus){
				cmdBytes[0] = (byte) 0xb7;
			}	
			else if(v.getId() == R.id.btn_program_minus){
				cmdBytes[0] = (byte) 0xb8;
			}
